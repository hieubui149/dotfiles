...
set -g window-status-format "#[fg=white,bg=#2e3540] #I  #[fg=white,bg=#2e3540]#W #F #[fg=#1b1f30,bg=#2e3540]▕"
...
set -g window-status-current-format "#[fg=#2e3540,bg=#89c0d0]   #[fg=#2e3540,bg=#89c0d0]#[fg=#2e3540,bg=#89c0d0]#W #F #[fg=#2e3540,bg=#89c0d0]"
